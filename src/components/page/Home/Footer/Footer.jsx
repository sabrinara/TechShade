...
const Footer = () => {
    return (
        <footer className="w-full bg-blue-950 p-8">
            <div className="flex flex-row flex-wrap items-center justify-center gap-y-6 gap-x-12 bg-blue-950 text-white text-center ">
            ...
            <p className="block text-white text-center font-sans text-base font-normal leading-relaxed text-blue-gray-900 antialiased">
                © 2023, Sabrina Rashid <br /> <small>All Rights Reserved</small>
            </p>
        </footer>
    );
};
